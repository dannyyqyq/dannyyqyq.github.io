...
For more details, check out the [project repository on GitHub](https://github.com/dannyyqyq/A-B_Testing/tree/main).
...
- [Data Overview \& Preparation  ](#data-overview--preparation--)
- [Applying Chi-Square Test For Independence ](#applying-chi-square-test-for-independence-)
      - [State Hypotheses \& Acceptance Criteria For Test](#state-hypotheses--acceptance-criteria-for-test)
      - [Calculate Observed Frequencies \& Expected Frequencies](#calculate-observed-frequencies--expected-frequencies)
